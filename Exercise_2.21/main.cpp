...
// g++ -std=c++17 main.cpp point.cpp drawables.cpp -o main -DSFML_STATIC -IC:\SFML-2.5.1\include -LC:\SFML-2.5.1\lib -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lopengl32 -lgdi32 -lws2_32 -lwinmm
int main() {
